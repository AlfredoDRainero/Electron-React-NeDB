...
const {
  getBooleanOption,
  cppdb
} = __webpack_require__(/*! ../util */ "./node_modules/better-sqlite3/lib/util.js");
...
/***/ "./src/services/database/FilesToDb.js":
/*!********************************************!*\
  !*** ./src/services/database/FilesToDb.js ***!
  \********************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {
...
const path = __webpack_require__(/*! path */ "path");
const fs = __webpack_require__(/*! fs */ "fs");
const Database = __webpack_require__(/*! better-sqlite3 */ "./node_modules/better-sqlite3/lib/index.js");
/*
const {
  agregarNombreEnDB
...
const {
  ...
  splitTextTitulo,
  SubcadenaAGuionBajo
} = __webpack_require__(/*! ../../utils/TextFormater */ "./src/utils/TextFormater.js");
const {
  obtenerFechaMedicion,
  obtenerYearFromDate,
  obtenerMonthFromDate
} = __webpack_require__(/*! ../../utils/fecha */ "./src/utils/fecha.js");
const {
  readFilesInFolder
} = __webpack_require__(/*! ./LoadDatabase_BSQLITE3 */ "./src/services/database/LoadDatabase_BSQLITE3.js");
const {
  leerNumeroPartnb,
  actualizarNumeroPartnb
} = __webpack_require__(/*! ./PartnBToDB_NEDB */ "./src/services/database/PartnBToDB_NEDB.js");
const {
  saveContenidoDataToDB
} = __webpack_require__(/*! ./SaveCHRtoDatabase_BSQLITE3 */ "./src/services/database/SaveCHRtoDatabase_BSQLITE3.js");
const {
  saveTituloDataToDB
} = __webpack_require__(/*! ./SaveHDRtoDatabase_BSQLITE3 */ "./src/services/database/SaveHDRtoDatabase_BSQLITE3.js");
...
async function SaveFilesToDB(ubicacion) {
  ...
  for (const archivo of archivos) {
    ...
    const dbPath = path.join(userData, `./data/${SubcadenaAGuionBajo(archivoTitulo)}_${year}_${month}.db`);
...
/***/ "./src/services/database/LoadDatabase_BSQLITE3.js":
/*!********************************************************!*\
  !*** ./src/services/database/LoadDatabase_BSQLITE3.js ***!
  \********************************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {
...
/***/ "./src/services/database/PartnBToDB_NEDB.js":
/*!**************************************************!*\
  !*** ./src/services/database/PartnBToDB_NEDB.js ***!
  \**************************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {
...
function leerNumeroPartnb(callback) {
  ...
  const db2 = new Datastore({
    filename: "./src/services/database/partnb.db",
    autoload: true
  });
...
/***/ "./src/services/database/SaveCHRtoDatabase_BSQLITE3.js":
/*!*************************************************************!*\
  !*** ./src/services/database/SaveCHRtoDatabase_BSQLITE3.js ***!
  \*************************************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

const sqlite = __webpack_require__(/*! better-sqlite3 */ "./node_modules/better-sqlite3/lib/index.js");
  ...
  try {
    ...
    db.transaction(() => {
      data.forEach((row, index) => {
        ...
        console.log("");
        if (index === 0) {} else if (insertValues.length === columnNames.length + 1) {
...
/***/ "./src/services/database/SaveHDRtoDatabase_BSQLITE3.js":
/*!*************************************************************!*\
  !*** ./src/services/database/SaveHDRtoDatabase_BSQLITE3.js ***!
  \*************************************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {
...
/***/ "./src/services/database/loadDB_NEDB.js":
/*!**********************************************!*\
  !*** ./src/services/database/loadDB_NEDB.js ***!
  \**********************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {
...
} = __webpack_require__(/*! ../files/files */ "./src/services/files/files.js");
...
function splitTextTitulo(text, partnb) {
  ...
  //console.log()
  const palabrasClave = ["filename", "operid", "date", "time", "dmesn", "partcomment", "orden", "temperatureworkpiece"];
...
const {
  SaveFilesToDB
} = __webpack_require__(/*! ./services/database/FilesToDb */ "./src/services/database/FilesToDb.js");
const {
  obtenerRegistrosEncontrados
} = __webpack_require__(/*! ./services/database/loadDB_NEDB */ "./src/services/database/loadDB_NEDB.js");
...
const createWindow = () => {
  ...
  const mainWindow = new BrowserWindow({
    ...
    webPreferences: {
      ...
      preload: 'C:\\Users\\vwari8y.VW\\Documents\\informesCZ\\prueba4\\Electron-React-NeDB\\.webpack\\renderer\\main_window\\preload.js'
    }
  });
